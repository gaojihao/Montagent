...
**This file** teaches how Montagent uses Remotion — which compositions map to pipeline
...
| Montagent Artifact | Remotion Prop | Maps To |
|---------------------|---------------|---------|
...
| Montagent Profile | Remotion Config |
|--------------------|-----------------|
