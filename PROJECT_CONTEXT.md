# Montagent - Shared Project Context
...
Montagent is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How Montagent uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when Montagent should pick HyperFrames vs Remotion, artifact → workspace mapping |
