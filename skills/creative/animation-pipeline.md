...
Animation work in Montagent runs on one of two composition runtimes. Both
...
| **Web/explainer standard** | 30 | Default for YouTube/web video. Montagent default. |
...
**Montagent default:** 30fps. Render Manim at 60fps and transcode to 30fps for smoother motion at delivery frame rate.
...
## Applying to Montagent

When building animation/motion graphics content:

1. **Render at 30fps** (Montagent default) — Manim at 60fps, transcode down
